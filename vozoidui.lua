...
function Library:Window(cfg)
    ...
    function win:Tab(name)
        ...
        function tab:Section(sectionName, side)
            ...
            ---------------------------------------------------------
            -- TOGGLE — the click target is a TOP-LEVEL TextButton
            ---------------------------------------------------------
            function sec:Toggle(o)
                ...
                -- The click surface is the whole row. It's a TextButton,
                -- created LAST so it renders above the decorative elements.
                -- There is no element with higher ZIndex inside this row
                -- except the swatch, which handles its own clicks.
                ...
                -- click surface: top-level, above label and checkbox
                ...
                local function rebuild()
                    ...
                    for i, v in ipairs(values) do
                        ...
                        b.MouseButton1Click:Connect(function()
                            ...
                            open = false; list.Visible = false; rebuild()
                            fire(o.Callback, v)
                        end)
                    end
            ...
            function sec:Keybind(o)
                ...
                local item = {
                    Name = o.Name, Flag = flag, Value = key,
